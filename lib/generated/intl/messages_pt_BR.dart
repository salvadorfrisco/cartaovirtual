...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "backgroundImage" : MessageLookupByLibrary.simpleMessage("Imagem de fundo"),
    "cellPhone" : MessageLookupByLibrary.simpleMessage("celular"),
    "cellPhoneHint" : MessageLookupByLibrary.simpleMessage("digite o telefone celular"),
    ...
    "emailAddressHint" : MessageLookupByLibrary.simpleMessage("endereço do e-mail ou qualquer texto"),
    "enhanceYourImage" : MessageLookupByLibrary.simpleMessage("Incremente sua imagem"),
    "facebookAddressHint" : MessageLookupByLibrary.simpleMessage("endereço do Facebook (opcional)"),
    "goBack" : MessageLookupByLibrary.simpleMessage("voltar"),
    "imageUpload" : MessageLookupByLibrary.simpleMessage("upload de imagem"),
    "includePhotoFromGallery" : MessageLookupByLibrary.simpleMessage("Incluir foto da galeria"),
    "instagramAddressHint" : MessageLookupByLibrary.simpleMessage("endereço do Instagram (opcional)"),
    "invalidCellPhone" : MessageLookupByLibrary.simpleMessage("Celular inválido"),
    "linkedinAddressHint" : MessageLookupByLibrary.simpleMessage("endereço do Linkedin ou qualquer texto"),
    "makeYourLayout" : MessageLookupByLibrary.simpleMessage("Faça seu layout"),
    "nameHint" : MessageLookupByLibrary.simpleMessage("digite o nome"),
    "next" : MessageLookupByLibrary.simpleMessage("avançar"),
    "occupationHint" : MessageLookupByLibrary.simpleMessage("digite a profissão ou serviço"),
    ...
    "twitterAddressHint" : MessageLookupByLibrary.simpleMessage("endereço do Twitter ou qualquer texto"),
    "txtTip1" : MessageLookupByLibrary.simpleMessage("Os ícones do lado esquerdo aparecerão somente se estiverem habilitados"),
    "txtTip2" : MessageLookupByLibrary.simpleMessage("Divulgue seus serviços, convites, feeds em redes sociais compartilhando a imagem em "),
    "txtTip3a" : MessageLookupByLibrary.simpleMessage("Clique no botão "),
    "txtTip3b" : MessageLookupByLibrary.simpleMessage("Incluir foto..."),
    "txtTip3c" : MessageLookupByLibrary.simpleMessage(" acima para incluir uma foto da galeria na imagem "),
    "txtTip4a" : MessageLookupByLibrary.simpleMessage("Troque a imagem de fundo clicando em "),
    "txtTip4b" : MessageLookupByLibrary.simpleMessage(" selecione uma imagem ou faça upload em "),
    "txtTip5a" : MessageLookupByLibrary.simpleMessage("Controle a opacidade da imagem de fundo, clique em "),
    "txtTip5b" : MessageLookupByLibrary.simpleMessage(" , deslize o botão do lado direito e veja o efeito "),
    "txtTip6a" : MessageLookupByLibrary.simpleMessage("Altere a posição das informações, clique em "),
    "txtTip6b" : MessageLookupByLibrary.simpleMessage(" segure o item e arraste para o local desejado "),
    "txtTip7" : MessageLookupByLibrary.simpleMessage("Os textos em cinza claro são apenas sugestões, você pode incluir qualquer texto para aparecer na imagem"),
    ...
    "websiteAddressHint" : MessageLookupByLibrary.simpleMessage("endereço do site ou qualquer texto"),
    ...
    "youtubeAddressHint" : MessageLookupByLibrary.simpleMessage("endereço do Youtube ou qualquer texto")
  };
}
